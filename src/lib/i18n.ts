...
export const dictionaries = {
  th: {
    ...
    common: {
      ...
      documentDateFrom: "วันที่เอกสารจาก",
      documentDateTo: "วันที่เอกสารถึง",
    ...
    auth: {
      ...
      loginDescriptionProduction:
        "ใช้อีเมล username หรือเบอร์โทร พร้อมรหัสผ่านของบัญชีในองค์กร",
    ...
    dashboard: {
      ...
      awaitingReceiptTitle: "PR รอรับสินค้า",
      awaitingReceiptSubtitle: "รายการที่สั่งซื้อแล้วและยังไม่ได้ยืนยันรับของ",
      urgentTitle: "รายการเร่งด่วน",
      viewAll: "ดูทั้งหมด",
      emptyPending: "ไม่มีรายการค้างอนุมัติในตอนนี้",
      chartTitle: "สรุปจำนวน PR",
      chartCountLabel: "จำนวน PR",
      chartDay: "รายวัน",
      chartWeek: "รายสัปดาห์",
      chartMonth: "รายเดือน",
    },
    purchaseRequests: {
      ...
      previewTitle: "พรีวิวไฟล์แนบ",
      previewAttachment: "ดูตัวอย่าง",
      previewLoading: "กำลังโหลดตัวอย่างไฟล์...",
      previewLoadError: "ไม่สามารถโหลดตัวอย่างไฟล์ได้",
      previewUnsupported: "ไฟล์ประเภทนี้ยังไม่รองรับการพรีวิวในระบบ",
      previewUnsupportedDescription: "กรุณาดาวน์โหลดไฟล์เพื่อเปิดดูรายละเอียด",
      paginationLabel: "แบ่งหน้ารายการ Purchase Request",
      paginationSummary: "หน้า {page} จาก {totalPages} · ทั้งหมด {totalCount} รายการ",
      previousPage: "ก่อนหน้า",
      nextPage: "ถัดไป",
      loadingMore: "กำลังโหลดรายการเพิ่มเติม...",
      loadMoreError: "ไม่สามารถโหลดรายการ PR เพิ่มเติมได้",
      removeAttachment: "ลบไฟล์",
      deleteAttachmentSuccess: "ลบไฟล์แนบเรียบร้อย",
      deleteAttachmentError: "ลบไฟล์แนบไม่สำเร็จ",
    ...
    admin: {
      ...
      loadingMoreUsers: "กำลังโหลดผู้ใช้งานเพิ่มเติม...",
      loadMoreUsersError: "ไม่สามารถโหลดรายชื่อผู้ใช้งานเพิ่มเติมได้",
    ...
    sortOptions: {
      pr_desc: "เลข PR มากสุดไปน้อยสุด",
      pr_asc: "เลข PR น้อยสุดไปมากสุด",
      updated_desc: "เวลาอัปเดตล่าสุด",
      status_asc: "สถานะ",
    },
    roles: {
      EMPLOYEE: "พนักงาน",
  ...
  en: {
    ...
    auth: {
      ...
      loginDescriptionProduction:
        "Use your email, username, or phone number with your organization account password.",
    ...
    dashboard: {
      ...
      awaitingReceiptTitle: "PRs awaiting receipt",
      awaitingReceiptSubtitle: "Requests already ordered but not yet marked as received",
      urgentTitle: "Urgent queue",
      viewAll: "View all",
      emptyPending: "No pending approvals right now",
      chartTitle: "PR volume summary",
      chartCountLabel: "PR count",
      chartDay: "Daily",
      chartWeek: "Weekly",
      chartMonth: "Monthly",
    },
    purchaseRequests: {
      ...
      previewLoadError: "Unable to load the file preview",
      previewUnsupported: "This file type is not supported for in-app preview",
      previewUnsupportedDescription: "Please download the file to inspect its contents",
      paginationLabel: "Purchase Request pagination",
      paginationSummary: "Page {page} of {totalPages} · {totalCount} items",
      previousPage: "Previous",
      nextPage: "Next",
      loadingMore: "Loading more requests...",
      loadMoreError: "Unable to load more purchase requests",
      removeAttachment: "Remove file",
      deleteAttachmentSuccess: "Attachment deleted successfully",
      deleteAttachmentError: "Unable to delete the attachment",
    ...
    admin: {
      ...
      loadMoreUsersError: "Unable to load more users",
    ...
    sortOptions: {
      pr_desc: "Highest PR number first",
      pr_asc: "Lowest PR number first",
